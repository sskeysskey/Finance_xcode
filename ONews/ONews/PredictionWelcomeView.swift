...
struct PredictionFloatingTopicsView: View {
...
struct PredictionWelcomeView: View {
    ...
    var body: some View {
        // ✅ 移除了 NavigationStack，因为 ONews 的 SourceListView 已经提供了一个全局的 NavigationStack
        ZStack {
        ...
        // ✅ 这里的 navigationDestination 会自动挂载到父级（SourceListView）的 NavigationStack 上

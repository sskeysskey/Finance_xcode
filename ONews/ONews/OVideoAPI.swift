...
extension OVideoItem {
    ...
    var normalizedTypes: [String] {
        ...
        let typeMapping: [String: String] = [
            ...
            "选秀": "其它", "大陆综艺": "其它", "晚会": "其它", "日韩综艺": "其它", "欧美综艺": "其它",
            "相声": "其它", "访谈": "其它", "戏曲": "其它", "港台综艺": "其它", "国产综艺": "其它",

            "动画": "其它", "海外动漫": "其它", "鬼怪": "其它", "日本动漫": "其它", "综艺": "其它",
            "有声动漫": "其它", "机战": "其它", "日韩动漫": "其它", "欧美动漫": "其它", "脱口秀": "其它",
            "游戏": "其它", "热血": "其它", "致郁": "其它", "动漫片": "其它", "动漫": "其它",
            "动漫电影": "其它", "动画电影": "其它", "国产动漫": "其它", "真人秀": "其它",
        ]
